...
def generate_predictions_drifted_data(
    test_data, imputer_path, model_path, output_path, noise_level
):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_path", type=str, default="outputs/model/random_forest_model.pkl"
    )
    parser.add_argument(
        "--reference_output_path", type=str, default="outputs/data/reference_data.csv"
    )
    parser.add_argument(
        "--current_output_path", type=str, default="outputs/data/current_data.csv"
    )
